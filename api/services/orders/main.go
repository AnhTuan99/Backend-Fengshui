...
import (
	...
	"fengshui.com/back-fengshui/api/services/orders/build/all"
	"fengshui.com/back-fengshui/api/services/orders/build/crud"
	"fengshui.com/back-fengshui/api/services/orders/build/reporting"
	...
	"fengshui.com/back-fengshui/configs"
	"fengshui.com/back-fengshui/foundation/logger"
	"fengshui.com/back-fengshui/foundation/otel"
...
func main() {
	...
	log = logger.NewWithEvents(os.Stdout, logger.LevelInfo, "ORDERS", traceIDFn, events)
...
func run(ctx context.Context, log *logger.Logger) error {
	...
	kafkaService := configs.NewKafkaService(config)
